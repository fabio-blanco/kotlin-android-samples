package br.com.globalbyte.sample.ud.and.colormyviews

import android.graphics.Color
import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.view.View
import br.com.globalbyte.sample.ud.and.colormyviews.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setListeners() {
        val clickableViews: List<View> = with(binding) {
            listOf(
                boxOneText,
                boxTwoText,
                boxThreeText,
