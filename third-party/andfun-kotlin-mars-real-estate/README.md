...
Original code obtained from the [original github course repository](https://github.com/udacity/andfun-kotlin-mars-real-estate/) and adapted as an exercise.
The [original license](/third-party/andfun-kotlin-mars-real-estate/LICENSE.txt) was maintained for this project.
...
- Retrofit library (A http client):
...
- Parcelable objects in bundles:
  ...
  - [Parcelable implementation generator (plugin)](https://developer.android.com/kotlin/parcelize)

## License

[Original license for image and audio is CC BY 4.0 license and for code is Apache v2](/third-party/andfun-kotlin-mars-real-estate/LICENSE.txt)
