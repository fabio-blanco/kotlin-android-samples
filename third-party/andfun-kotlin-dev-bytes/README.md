...
Original code obtained from the [original github course repository](https://github.com/udacity/andfun-kotlin-dev-bytes/) and adapted as an exercise.
The [original license](/third-party/andfun-kotlin-dev-bytes/LICENSE.txt) was maintained for this project.
...
- [Jetpack Datastore](https://developer.android.com/topic/libraries/architecture/datastore), a data storing solution that allows you to
 store key-value pairs or typed objects with protocols buffers. Nowadays it is recommended to use
 DataStore instead of the outdated [SharedPreferences](https://developer.android.com/training/data-storage/shared-preferences)
- [Data and file storage overview](https://developer.android.com/training/data-storage)
- [Save data in a local database using Room](https://developer.android.com/training/data-storage/room)
- [Gide to app architecture](https://developer.android.com/topic/architecture)
- [Recommended Architecture - Data Layer](https://developer.android.com/topic/architecture#data-layer)
- [More about Data Layer](https://developer.android.com/jetpack/guide/data-layer)
- WorkManager:
  - [Introducing WorkManager](https://medium.com/androiddevelopers/introducing-workmanager-2083bcfc4712)
  - [WorkManager Codelab](https://codelabs.developers.google.com/codelabs/android-workmanager-kt/#0)
...
[Original license for image and audio is CC BY 4.0 license and for code is Apache v2](/third-party/andfun-kotlin-dev-bytes/LICENSE.txt)
